...
[DeviceProfile](https://github.com/salmanazmat666/go-mod-core-contracts/blob/master/models/deviceprofile.go) --
...
* Run ```go get github.com/salmanazmat666/go-mod-core-contracts```
